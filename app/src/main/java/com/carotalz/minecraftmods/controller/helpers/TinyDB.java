...
public class TinyDB {
    ...
    public ArrayList<ModModel> getListObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<ModModel> objects =  new ArrayList<ModModel>();

    	for(String jObjString : objStrings){
            ModModel value  = gson.fromJson(jObjString,  ModModel.class);
    		objects.add(value);
    	}
    	return objects;
    }
...
//    }
//    
    public void putListObject(String key, ArrayList<ModModel> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(ModModel obj : objArray){
